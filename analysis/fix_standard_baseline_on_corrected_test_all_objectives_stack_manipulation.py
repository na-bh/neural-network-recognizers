"""Evaluates the EXISTING standard-FLaRe-trained stack-manipulation models
(data/models/stack-manipulation/<arch>/<loss_terms>/validation-short/<trial> for
rnn/lstm/transformer, models/stack-manipulation/mamba/<loss_terms>/validation-
short/<trial> for mamba) on the CORRECTED test set. Pure evaluation, no
training.

PYTHONPATH=src:analysis python analysis/fix_standard_baseline_on_corrected_test_all_objectives_stack_manipulation.py
"""
...
STANDARD_MODELS_ROOT = REPO_ROOT / "data" / "models" / "stack-manipulation"
MAMBA_MODELS_ROOT = REPO_ROOT / "models" / "stack-manipulation"
FIXED_LANG_DIR = REPO_ROOT / "languages" / "stack-manipulation-fixed"
STANDARD_LANG_DIR = REPO_ROOT / "languages" / "stack-manipulation"
OUT_PATH = RESULTS / "fix_standard_baseline_on_corrected_test_all_objectives_stack_manipulation.json"
ARCHITECTURES = ["rnn", "lstm", "transformer", "mamba"]
N_TRIALS = 10


def main():
    results = {"task": "stack-manipulation",
