"""Evaluates the EXISTING standard-FLaRe-trained compute-sqrt models
(data/models/compute-sqrt/<arch>/<loss_terms>/validation-short/<trial> for
rnn/lstm/transformer, models/compute-sqrt/mamba/<loss_terms>/validation-
short/<trial> for mamba) on the CORRECTED test set. Pure evaluation, no
training.

PYTHONPATH=src:analysis python analysis/fix_standard_baseline_on_corrected_test_all_objectives_compute_sqrt.py
"""
...
STANDARD_MODELS_ROOT = REPO_ROOT / "data" / "models" / "compute-sqrt"
MAMBA_MODELS_ROOT = REPO_ROOT / "models" / "compute-sqrt"
FIXED_LANG_DIR = REPO_ROOT / "languages" / "compute-sqrt-fixed"
STANDARD_LANG_DIR = REPO_ROOT / "languages" / "compute-sqrt"
OUT_PATH = RESULTS / "fix_standard_baseline_on_corrected_test_all_objectives_compute_sqrt.json"
ARCHITECTURES = ["rnn", "lstm", "transformer", "mamba"]
N_TRIALS = 10


def main():
    results = {"task": "compute-sqrt",
