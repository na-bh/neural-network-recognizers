"""Evaluates the EXISTING standard-FLaRe-trained marked-copy models
(data/models/marked-copy/<arch>/<loss_terms>/validation-short/<trial> for
rnn/lstm/transformer, models/marked-copy/mamba/<loss_terms>/validation-
short/<trial> for mamba) on the CORRECTED test set. Pure evaluation, no
training.

PYTHONPATH=src:analysis python analysis/fix_standard_baseline_on_corrected_test_all_objectives_marked_copy.py
"""
...
STANDARD_MODELS_ROOT = REPO_ROOT / "data" / "models" / "marked-copy"
MAMBA_MODELS_ROOT = REPO_ROOT / "models" / "marked-copy"
FIXED_LANG_DIR = REPO_ROOT / "languages" / "marked-copy-fixed"
STANDARD_LANG_DIR = REPO_ROOT / "languages" / "marked-copy"
OUT_PATH = RESULTS / "fix_standard_baseline_on_corrected_test_all_objectives_marked_copy.json"
ARCHITECTURES = ["rnn", "lstm", "transformer", "mamba"]
N_TRIALS = 10


def main():
    results = {"task": "marked-copy",
