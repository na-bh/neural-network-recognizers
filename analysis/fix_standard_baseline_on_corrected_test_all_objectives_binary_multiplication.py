"""Evaluates the EXISTING standard-FLaRe-trained binary-multiplication models
(data/models/binary-multiplication/<arch>/<loss_terms>/validation-short/<trial> for
rnn/lstm/transformer, models/binary-multiplication/mamba/<loss_terms>/validation-
short/<trial> for mamba) on the CORRECTED test set. Pure evaluation, no
training.

PYTHONPATH=src:analysis python analysis/fix_standard_baseline_on_corrected_test_all_objectives_binary_multiplication.py
"""
...
STANDARD_MODELS_ROOT = REPO_ROOT / "data" / "models" / "binary-multiplication"
MAMBA_MODELS_ROOT = REPO_ROOT / "models" / "binary-multiplication"
...
OUT_PATH = RESULTS / "fix_standard_baseline_on_corrected_test_all_objectives_binary_multiplication.json"
ARCHITECTURES = ["rnn", "lstm", "transformer", "mamba"]
N_TRIALS = 10


def main():
    results = {"task": "binary-multiplication",
