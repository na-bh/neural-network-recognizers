"""Shared causal-patching runner functions for modular-arithmetic-simple's
...
PYTHONPATH=src:analysis python analysis/phase3_modarith_patching_common.py
"""
...
CELLS = [
    ("rnn", 4, "primary"), ("rnn", 5, "secondary"),
    ("lstm", 3, "primary"), ("lstm", 4, "secondary"),
    ("transformer", 5, "primary"), ("transformer", 2, "secondary"),
    ("mamba", 0, "primary"), ("mamba", 1, "secondary"),
]
...
def load_cell_selection_context():
    d = json.loads((RESULTS / "phase3_modarith_cell_selection.json").read_text())
